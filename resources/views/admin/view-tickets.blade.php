                                                ...
                                                <td>
													<div class="dropdown ml-auto text-right">
														...
														<div class="dropdown-menu dropdown-menu-right">
															...
															<a class="dropdown-item" href="javascript:;" ng-click="deleteTicketDetails(row.TICKET_ID);">Delete</a>
														</div>
													</div>
												</td>												
                                            </tr>
...
<!-- 									<form class="form-valide"> -->
										<div class="row">
											...
											<div class="col-sm-6">
												<div class="form-group" ng-show="ticket.T_1 == 'order'">
										...
										<div class="row">
											<div class="col-sm-6">
												<div class="form-group">
													...
													<input type="text" class="form-control" id="t3" ng-model="ticket['T_3']" placeholder="Username">
												</div>
											</div>
											<div class="col-sm-6">
												<div class="form-group">
...
<!-- 									</form> -->
												...
												<div class="border-bottom pb-7 mb-7 " ng-repeat="row in displayCollectionTicketReplies">
													<div class="row mt-3 mb-3" ng-if="row.USER_TYPE == 'user'">
														<div class="w-70px d-block mr-6 col-sm-1">
															<img src="{{url('assets-web')}}/images/comment-01.png" alt="Dean. D">
														</div>
    ...
    <script src="{{ url('/assets-admin') }}/customjs/script_adminusertickets.js?v={{time()}}"></script>
