    ...
    <div class="content-body" ng-controller="projectinfo1">
        <div class="container-fluid pt-0" ng-show="editView == '0'">
            ...
            <div class="row mt-4">
                ...
                <div class="col-3">
                    <a type="button" class="btn btn-rounded btn-warning admin-view-add mb-3" href="javascript:void(0)"
                            ...
                            <div class="table-responsive">
                                <table id="productsTable" class="display min-w850">
                                    ...
                                    <tbody id="tablecontents">
                                        ...
                                        <tr class="row1" data-seq="@{{ row.SEQ_NUM }}"
                                            data-id="@{{ row.PRODUCT_ID }}" ng-repeat="row in displayCollection">
                                                ...
                                                <div class="dropdown ml-auto text-right">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a class="dropdown-item" href="javascript:;"
                                                            ng-click="changeStatusProduct(@{{ row.PRODUCT_ID }});"
                                                            ng-show="row.STATUS != 'active'">Active</a>
                                                        <a class="dropdown-item" href="javascript:;"
                                                            ng-click="changeStatusProduct(@{{ row.PRODUCT_ID }});"
                                                            ng-show="row.STATUS == 'active'">InActive</a>
                                                        <a class="dropdown-item" href="javascript:;"
                                                            ng-click="continouRecord(@{{ row.PRODUCT_ID }});">Edit</a>
                                                        <a class="dropdown-item" href="javascript:;"
        ...
        <div class="container-fluid pt-0" ng-show="editView == '1'">
            <div class="page-titles pt-0 mb-0">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item" ng-click="backToListing();"><i class="fa fa-arrow-left p-1"></i>
                        &nbsp;<a href="javascript:void(0)">Product</a></li>
                        ...
                        <div class="card-body">
                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                ...
                                <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#description">
                                        <span> Section Two Information </span>
                                    </a></li>
                            </ul>
                            <!-- Tab panes -->
                                            ...
                                            <form class="form-valide" action="#" method="post">
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <label class="col-form-label" for="name"><b>Product
                                                                    Name</b> <span class="text-danger">*</span>
                                                            </label>
                                                            <input type="text" class="form-control" id="title"
                                                                ng-model="product['P_1']"
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <label class="col-form-label" for="sub_title"><b>Sub
                                                                    Title</b> </label>
                                                            <input type="text" class="form-control" id="sub_title"
                                                                ng-model="product['P_2']"
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <label class="col-form-label" for="unit"><b>Unit
                                                                    Size</b> </label>
                                                            <input type="text" class="form-control" id="unit"
                                                                ng-model="product['P_3']" placeholder="Unit"
                                                                maxlength="8">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <label class="col-form-label"
                                                                for="sub_category"><b>Product Sub Category</b> <span
                                                                    class="text-danger">*</span> </label>
                                                            <select class="form-control" id="p9"
                                                                ng-model="product['P_9']"
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            <label class="col-form-label"
                                                                for="sub_sub_category"><b>Product Sub Sub Category</b>
                                                                <span class="text-danger">*</span> </label>
                                                            <select class="form-control" id="p44"
                                                                ng-model="product['P_44']"
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <label><b>Your Daily Hand Picked<span
                                                                    class="required-field">*</span></b></label>
                                                        <select class="default-placeholder select2-hidden-accessible"
                                                            id="p47" multiple='multiple'
                                                            ng-model="product['P_47']"
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <label class="col-form-label" for="short_description"><b>Short
                                                                Description</b></label>
                                                        <textarea class="form-control" id="short_description" rows="8" ng-model="product['P_11']"
                                ...
                                <div class="tab-pane fade" id="description" role="tabpanel">
                                    <div class="pt-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="desc_title" class="form-control"
                                                ng-model="product['P_12']">
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-12 pt-4">
                                    <a type="button" class="btn btn-rounded btn-warning admin-view-add mb-3"
                                        ng-click="saveProductBasic();">Save Basic Info</a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-xl-12 col-xxl-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" data-toggle="tab" href="#images"> <span> Image </span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                                    ...
                                                    <div class="row register-new-product-picture-para">
                                                        ...
                                                        <form class="" id="uploadattch" method="POST"
                                                            ...
                                                            <input type="hidden" id="sourceCode" name="sourceCode"
                                                                value="PRODUCT_IMG">
                                                            <input type="file" id="uploadattl" name="uploadattl"
                                ...
                                <div class="tab-pane fade" id="video" role="tabpanel">
                                    <div class="pt-4">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        ng-model="video['V_1']" placeholder="Video Title">
                                        ...
                                        <div class="col-sm-12 col-12 register-new-product-picture-para-box">
                                            <div class="row register-new-product-picture-para">
                                                <div class="col-sm-2 image-overlay upload-photo-box"
                                                    id="imageAttach-btn" onclick="form2();" style="">
                                                    <img src="{{ url('/assets-admin') }}/images/admin/upload.svg"
                                                        alt="" width="50">
                                                    <p>Upload Video</p>
                                                </div>
              ...
              <div class="row" id="p_att">
                                        ...
                                        <div class="row">
                                            <div class="col-12 pt-4">
                                                <a type="button"
                                                    class="btn btn-rounded btn-warning admin-view-add mb-3"
                                                    ng-click="saveProductVideo();">Save Video</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="tab-pane fade show active" id="pricing" role="tabpanel">
                                    <div class="pt-4">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" id="p14"
                                                        ng-model="product['P_14']" min="0">
                                                </div>
                                            </div>
                                            <!-- <div class="col-sm-6">
                                                <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label class="col-form-label" for="discount"><b>Discount</b>
                                                    </label>

                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <input type="number" class="form-control" id="p17"
                                                                ng-model="product['P_17']" min="0">
                                                        </div>
                                                        <div class="col-sm-6">
                                        ...
                                        <div class="row">
                                            ...
                                            {{-- <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <input type="number" class="form-control" id="p26"
                                                                ng-model="product['P_26']" min="0"
                                                                step="0.01">
                                                        </div>
                                                        <div class="col-sm-6">
                ...
                <div class="col-xl-12 col-xxl-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                <li class="nav-item"><a class="nav-link active" data-toggle="tab"
                                        href="#ingredients"> <span> Ingredients </span>
                                    </a></li>
                                <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#shades"> <span>
                                            Shades </span>
                                    </a></li>
                            </ul>
                            <!-- Tab panes -->
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <label class="col-form-label" for="ing_category"><b>Ingredient
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <label class="col-form-label" for="ingredient"><b>Ingredient</b>
                                                        <span class="text-danger">*</span> </label>
                                                    <select class="form-control" id="i2"
                                                        ng-model="ingredient['I_2']"
                                            ...
                                            <div class="col-sm-4 align-center-verticle">
                                                <button class="btn btn-rounded btn-warning cmbm-6vw mt-2"
                                                    ng-click="saveProductIngredient();"
                                                    ...
                                                    <tr ng-repeat="row in displayCollectionProdIngredients">
                                                        ...
                                                        <td>
                                                            <div class="dropdown ml-auto text-right">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    <a class="dropdown-item" href="javascript:;"
                                                                        ng-click="deleteProductingredient(@{{ row.PRODUCT_INGREDIENT_ID }});">Remove</a>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
              ...
              <label class="col-form-label" for="shade"><b>Shade</b> <span
               ...
               <option vlaue="1">Multi</option>
                                            ...
                                            <div class="col-sm-4 mb-4">
                                                <!-- align-center-verticle -->
                                                <button class="btn btn-rounded btn-warning mt-2 cmbm-6vw"
                                                    ng-click="addProductShade();">Add New</button>
                                            </div>
                                                    ...
                                                    <tr ng-repeat="row in displayCollectionProdShades">
                                                        ...
                                                        <td>
                                                            <div class="dropdown ml-auto text-right">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    <a class="dropdown-item" href="javascript:;"
                                                                        ng-click="editProductShade(@{{ row.PRODUCT_SHADE_ID }});">Edit</a>
                                                                    <a class="dropdown-item" href="javascript:;"
                                                                        ng-click="deleteProductShade(@{{ row.PRODUCT_SHADE_ID }});">Remove</a>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
                ...
                <div class="col-xl-12 col-xxl-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <!-- Nav tabs -->
                            <ul class="nav nav-tabs" role="tablist">
                                <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#step_1">
                                        <span> Steps </span>
                                    </a></li>
                                    ...
                                    <div class="pt-4">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-4 mb-4">
                                                <!-- align-center-verticle -->
                                                <button class="btn btn-rounded btn-warning mt-2 cmbm-6vw"
                                                    ng-click="addNewUses();">Add New</button>
                                            </div>
                                                    ...
                                                    <tr ng-repeat="row in displayCollectionProdUses">
                                                        ...
                                                        <td>
                                                            <div class="dropdown ml-auto text-right">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    <a class="dropdown-item" href="javascript:;"
                                                                        ng-click="editProductUses(@{{ row.PRODUCT_USES_ID }});">Edit</a>
                                                                    <a class="dropdown-item" href="javascript:;"
                                                                        ng-click="deleteProductUses(@{{ row.PRODUCT_USES_ID }});">Remove</a>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content tabcontent-border">
                                ...
                                <div class="tab-pane fade" id="shipping_conf" role="tabpanel">
                                    <div class="pt-4">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <div class="custom-control custom-checkbox mb-3 checkbox-warning">
                                                        <input type="checkbox" class="custom-control-input"
                                                            id="p28" ng-model="product['P_28']">
                                                        <label class="custom-control-label pl-4" for="p28">Free
                                                            Shipping</label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <div class="custom-control custom-checkbox mb-3 checkbox-warning">
                                                        <input type="checkbox" class="custom-control-input"
                                                            id="p29" ng-model="product['P_29']">
                                                        <label class="custom-control-label pl-4" for="p29">Is
                                                            Product Quantity Mulitiply</label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <div class="custom-control custom-checkbox mb-3 checkbox-warning">
                                                        <input type="checkbox" class="custom-control-input"
                                                            id="p30" ng-model="product['P_30']">
                                                        <label class="custom-control-label pl-4" for="p30">Flat
                                                            Rate</label>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <div class="custom-control custom-checkbox mb-3 checkbox-warning">
                                                        <input type="checkbox" class="custom-control-input"
                                                            id="p31" ng-model="product['P_31']">
                                                        <label class="custom-control-label pl-4" for="p31">Show
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <div class="custom-control custom-checkbox mb-3 checkbox-warning">
                                                        <input type="checkbox" class="custom-control-input"
                                                            id="p32" ng-model="product['P_32']">
                                                        <label class="custom-control-label pl-4" for="p32">Show
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <div class="custom-control custom-checkbox mb-3 checkbox-warning">
                                                        <input type="checkbox" class="custom-control-input"
                                                            id="p33" ng-model="product['P_33']">
                                                        <label class="custom-control-label pl-4" for="p33">Hide
                                                            Stock</label>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="tab-pane fade" id="deal_setting" role="tabpanel">
                                    <div class="pt-4">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label class="col-form-label" for="p34"><b>Shipping Days</b>
                                                    </label>
                                                    <input type="number" class="form-control" id="p34"
                                                        ng-model="product['P_34']" placeholder="Shipping Days">
                                            ...
                                            <div class="col-sm-6 align-center-verticle pt-5">
                                                <div class="form-group">
                                                    <div class="custom-control custom-checkbox mb-3 checkbox-warning">
                                                        <input type="checkbox" class="custom-control-input"
                                                            id="p35" ng-model="product['P_35']">
                                                        <label class="custom-control-label pl-4" for="p35">Today
                                                            Deal</label>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="tab-pane fade" id="flash_deal" role="tabpanel">
                                    <div class="pt-4">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label class="col-form-label" for="add_to_flash"><b>Add to Flash
                                                        </b> </label>
                                                    <select class="default-placeholder select2-hidden-accessible"
                                                        id="p36" ng-model="product['P_36']">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" id="p37" ng-model="product['P_37']"
                                                        class="form-control">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label class="col-form-label" for="discount_type"><b>Discount
                                                            Type</b> </label>
                                                    <select class="form-control" id="p38"
                                                        ng-model="product['P_38']">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <div class="custom-control custom-checkbox mb-3 checkbox-warning">
                                                        <input type="checkbox" class="custom-control-input"
                                                            id="p39" ng-model="product['P_39']">
                                                        <label class="custom-control-label pl-4" for="p39">Cash
                                                            On Delivery</label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <div class="custom-control custom-checkbox mb-3 checkbox-warning">
                                                        <input type="checkbox" class="custom-control-input"
                                                            id="p40" ng-model="product['P_40']">
                                                        <label class="custom-control-label pl-4"
                                                            for="p40">Featured</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <div class="custom-control custom-checkbox mb-3 checkbox-warning">
                                                        <input type="checkbox" class="custom-control-input"
                                                            id="p41" ng-model="product['P_41']">
                                                        <label class="custom-control-label pl-4"
                                                            for="p41">Todays Deal</label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label class="col-form-label" for="p42"><b>Low Quantity
                                                            Warning </b> </label>
                                                    <input type="number" class="form-control" id="p42"
                                                        ng-model="product['P_42']">
                                ...
                                <div class="tab-pane fade show active" id="clinical_note" role="tabpanel">
                                    <div class="pt-4">
                                        ...
                                        <div class="col-sm-12 col-12 register-new-product-picture-para-box">
                                            <div class="row register-new-product-picture-para">
                                                <div class="col-sm-2 image-overlay upload-photo-box"
                                                    id="imageAttach-btn" onclick="form5();" style="">
                                                    <img src="{{ url('/assets-admin') }}/images/admin/upload.svg"
                                                        alt="" width="50">
                                                    <p>Min: 270 X 370</p>
                                                </div>
                                                ...
                                                <form class="" id="uploadattch5" method="POST"
                                                    ...
                                                    <input type="hidden" id="sourceCode" name="sourceCode"
                                                        value="CLINICAL_NOTE">
                                                    <input type="file" id="uploadatt5" name="uploadattl"
                                                        class="file-input" style="display: none;">
                                                </form>
              ...
              <div class="fallback">
               <input name="clinicalfile" type="file" accept="video/*" />
                                ...
                                <div class="row">
                                    <div class="col-12 pt-4">
                                        <a type="button" class="btn btn-rounded btn-warning admin-view-add mb-3"
                                            ng-click="saveProductOtherInfo();">Save Other Info</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="col-sm-12 col-12 register-new-product-picture-para-box mt-4">
                            <div class="row register-new-product-picture-para">
                                <div class="pt-4 image-overlay upload-photo-box" id="imageAttach-btn"
                                    onclick="form3();" style="">
                                ...
                                <form class="" id="uploadattch3" method="POST"
                                    ...
                                    <input type="file" id="uploadatt3" name="uploadattl" class="file-input"
                                        style="display: none;">
                                </form>
                        ...
                        <div class="col-sm-12 col-12 register-new-product-picture-para-box mt-4" id="imageBox" >
                            <div class="row register-new-product-picture-para">
                                ...
                                <div class="col-sm-7">
                                    <div class="row" id="ps_att">
                                        <div class="col-3 image-overlay margin-r1" id="img_file"
                                            ...
                                            <div class="overlay">
                                                <div class="text">
                                                    <img class="fa-trash-alt"
                                                        src="{{ url('/assets-admin') }}/images/admin/trash.svg"
                                                        alt="" width="18"
                                                        ng-click="deleteProductUsesImage(@{{ uses.ID }})"
                                                        title="Delete Image">
                                                    <div class="arrow-icon-move-box">
                                                        <img class="arrow-center"
                                                            src="{{ url('/assets-admin') }}/images/admin/feather-move.svg"
                                                            alt="">
                                                        <p>Move Position</p>
                                                    </div>
                                                </div>
                                ...
                                <form class="" id="uploadattch4" method="POST"
                                    ...
                                    <input type="file" id="uploadatt4" name="uploadattl" class="file-input"
                                        style="display: none;">
                                </form>
