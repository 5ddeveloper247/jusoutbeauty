    ...
    ********************-->
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="{{session('site')}}/dashboard" class="brand-logo">
				...
				<img class="brand-title brand-title-custom" src="{{ url('/assets-admin') }}/images/admin/Logo-01.png">
            </a>
...
<!--                                     </a> -->
                                    <a href="{{session('site')}}/adminlogout" class="dropdown-item ai-icon">
...
<!--                             <li><a href="{{session('site')}}/add-product">Add</a></li> -->
                            <li><a href="{{session('site')}}/view-ingredients">Ingredients</a></li>
                            <li><a href="{{session('site')}}/view-all-shades">Shades</a></li>
							<li><a href="{{session('site')}}/view-features">Features</a></li>
                            <li><a href="{{session('site')}}/view-all-selfi">All Selfies</a></li>
<!--                             <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">Ingredients</a> -->
<!--                                 <ul aria-expanded="false"> -->
<!--                                     <li><a href="{{session('site')}}/view-ingredients">View All</a></li> -->
<!--                                     <li><a href="{{session('site')}}/add-ingredient">Add new</a></li> -->
<!--                                 </ul> -->
<!--                             </li> -->
<!--                             <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">Shades</a> -->
<!--                                 <ul aria-expanded="false"> -->
<!--                                     <li><a href="{{session('site')}}/view-all-shades">View All</a></li> -->
...
<!--                             <li><a href="{{session('site')}}/blogs">View All</a></li> -->
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                        	<li><a href="{{session('site')}}/snapSelfie">Snap Selfie</a></li>
                            <li><a href="{{session('site')}}/shade-finder-quiz-yes">Yes</a></li>
                            <li><a href="{{session('site')}}/shade-finder-quiz-no">No</a></li>
                        </ul>
                    </li>
                    <!-- <li><a class="ai-icon" href="{{session('site')}}/shade-finder-quiz" aria-expanded="false">
							<i class="fa fa-bullhorn"></i>
                     ...
                     <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{session('site')}}/orders">Placed Orders</a></li>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{session('site')}}/apis">View All</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
...
<!--                             <li><a href="{{session('site')}}/header">Header</a></li> -->
					...
					<li>
                        <a class="ai-icon" href="{{session('site')}}/givings" aria-expanded="false">
							<i class="fa fa-credit-card"></i>
							<span class="nav-text">Giving</span>
						</a>
                    </li><li>
                        <a class="ai-icon" href="{{session('site')}}/routine_type" aria-expanded="false">
							<i class="fa fa-credit-card"></i>
							<span class="nav-text">Routine</span>
						</a>
                    </li>
                    <!-- <li>
                        <a class="ai-icon" href="{{session('site')}}/delivery" aria-expanded="false">
							<i class="fa fa-truck"></i>
							<span class="nav-text">Delivery</span>
						</a>
                    </li> -->
                    <li>
                    	<a class="ai-icon" href="{{session('site')}}/user-Tickets" aria-expanded="false">
							<i class="fa fa-ticket"></i>
							<span class="nav-text">Tickets</span>
						</a>
                    </li>
                    <li>
                        <a class="ai-icon" href="{{session('site')}}/reviews" aria-expanded="false">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{session('site')}}/emails-settings">Email Settings</a></li>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{session('site')}}/allsub">Subscriptions</a></li>
                            <li><a href="{{session('site')}}/user-subscriptions">User's Subscriptions</a></li>
                        </ul>
                    </li>
                    <li>
                    	<a class="ai-icon" href="{{session('site')}}/newsLatters" aria-expanded="false">
							<i class="fa fa-ticket"></i>
