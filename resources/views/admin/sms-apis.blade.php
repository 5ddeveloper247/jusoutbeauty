        ...
        <div class="content-body">
            <div class="container-fluid">
                <div class="page-titles">
					<ol class="breadcrumb">
						<li class="breadcrumb-item"><a href="javascript:void(0)">SMS APIs</a></li>
                ...
                <div class="row">
                   <div class="col-12">
                       <a type="button" class="btn btn-rounded btn-warning admin-view-add mb-3" href="/add-sms-api">Add new</a>
                   </div>
                </div>
                <div class="row">
					...
					<div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">SMS APIs</h4>
                            </div>
                            <div class="card-body">
                                                ...
                                                <td>
													<div class="dropdown ml-auto text-right">
														...
														<div class="dropdown-menu dropdown-menu-right">
															...
															<a class="dropdown-item" href="/edit-sms-api">Edit</a>
