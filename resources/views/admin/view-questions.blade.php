...
<head>
    <title>Question — JustBeauty</title>
                                            ...
                                            <tr>
                                                ...
                                                <td>
													<div class="dropdown ml-auto text-right">
														...
														<div class="dropdown-menu dropdown-menu-right">
															<a class="dropdown-item" href="#" data-toggle="modal" data-target=".send_repy">View</a>
														</div>
													</div>
												</td>												
                                            </tr>
						...
						<div class="modal-body">
						     ...
						     <div class="row">
						       <div class="col-sm-12">
						         ...
						         <textarea class="form-control" name="answer_qtn" id="answer_qtn" placeholder="Enter Answer..."></textarea>
						       </div>
						     </div>
