 ...
 <main ng-app="project1">
 	<section class="py-10 mt-15 mt-15-67 bg-gray-1 hero-section">
 		<div class="container">
 			<h2 class="mb-2 text-center banner-font" data-animate= "fadeInRight" style="color: white"><?php echo isset($categoryName['NAME']) ? $categoryName['NAME'] : 'Store'; ?></h2>
 									...
 									<?php if (isset($categoryFilter) && !empty($categoryFilter)) { ?>
 										<?php foreach ($categoryFilter as $filter) { ?>
 											...
 											<li class="mb-1 d-flex" id="categoryFilter_{{$filter['SUB_SUB_CATEGORY_ID']}}">
 												<input type="checkbox" class="category-filter mr-1" id="categoryFilterInput_{{$filter['SUB_SUB_CATEGORY_ID']}}" value="{{$filter['SUB_SUB_CATEGORY_ID']}}" ng-click="filter();">
 												<label for="categoryFilterInput_{{$filter['SUB_SUB_CATEGORY_ID']}}" data-toggle="tooltip" data-placement="top" title="{{$filter['SUB_CATEGORY_NAME']}}/{{$filter['NAME']}}" style="white-space: nowrap;overflow: hidden;text-overflow: ellipsis;margin-top: 6px;"> {{$filter['SUB_CATEGORY_NAME']}}/{{$filter['NAME']}}</label>
 											</li>
 										<?php } ?>
 									<?php } ?>
 								</ul>
 				...
 				<div class="col-xl-12 shop-listing-right-portion">
 							...
 							<div class="modal-dialog quick_view_mbl modal-dialog-scrollable">
 								<div class="modal-content p-0 quick_view_mbl_carousel_modal">
 									<div class="modal-body p-0">
 										<button type="button" class="close fs-32 pr-0 pt-0 pr-md-3 pt-md-2 position-absolute pos-fixed-top-right z-index-10" data-dismiss="modal" aria-label="Close">
 											...
 											<div class="col-sm-6 col-md-6 primary-summary " style="padding: 15px; height: 35rem; overflow:auto;">
 												...
 												<div class="primary-summary-inner" style="padding-bottom: 25px;">
 													...
 													<div class="chooseShade-container" style="margin-bottom: 30px;" ng-if="displayCollectionBundleProductShadesQuickView != ''">
														<div id="shadeBundlechooser_container_@{{row.BUNDLE_LINE_ID}}" ng-repeat="row in displayCollectionBundleProductShadesQuickView" ng-show='row.productShades != null'>
															<button class="accordion_inc_prod_detail shadeAccord-btn" data-id="@{{row.BUNDLE_LINE_ID}}">Choose Shade Product @{{row.productName}}</button><!-- @{{row.seqNo}}. chooseShadeBtn -->
 												...
 												<div class=" form-group mb-0 sub-form" style="display: none;">
 													<div class="d-flex align-items-center mb-1">
 														...
 														<a href="#" ng-click="showSubscrptionDetailModal()" data-toggle="tooltip" data-placement="top" title="Click to see more Ingredients" class="text-right">Learn More
 														</a>
 														...
 														<div class="modal fade quick-view" id="learnmore_pop" tabindex="-1" aria-hidden="true">
 															<div class="modal-dialog" style="max-width: 631px !important;">
 																<div class="modal-content p-0">
 																	<div class="modal-body p-0">
 																		<button type="button" class="close fs-32 pr-0 pt-0 pr-md-3 pt-md-2 position-absolute pos-fixed-top-right z-index-10 close_learnmore_pop">
 													...
 													<div class="row align-items-end no-gutters mx-n2 mb-1">
 														...
 														<div class="col-sm-8 mb-0 px-2">
 															<button type="button"
					                                            ...
					                                            data-quantity='1' data-subs='1' ng-if="QuickView_invQty > '0'">Add to cart</button>
					                                       	<button type="button"
 					...
 					<div class="modal fade quick-view " id="bundleQuickView" tabindex="-1" aria-hidden="true">
 							<div class="modal-dialog quick_view_mbl modal-dialog-scrollable">
 								<div class="modal-content p-0 quick_view_mbl_carousel_modal">
 									<div class="modal-body p-0">
 										<button type="button" class="close pr-0 pt-0 pr-md-3 pt-md-2 fs-32 position-absolute pos-fixed-top-right z-index-10" data-dismiss="modal" aria-label="Close">
 											<span aria-hidden="true" class="fs-20">
 												<i class="fal fa-times"></i>
 											</span>
 										</button>
 											...
 											<div class="col-sm-6">
 												...
 												<div id="carouselExampleControls" class="carousel slide quick_view_mbl_carousel" data-ride="carousel" data-interval="2000">
 													<div class="carousel-inner">
 														<div class="carousel-item active">
 															<img class="d-block w-100 quick_view_mbl_carousel_img" style="height:35rem" src="@{{bundleImage}}" alt="First slide">
 														</div>
 													</div>
 													<a class="carousel-control-prev" href="#carouselExampleControls" role="button" data-slide="prev">
 														<span class="carousel-control-prev-icon" aria-hidden="true"></span>
 											...
 											<div class="col-sm-6 col-md-6 primary-summary " style="padding: 20px;">
												...
												<label for="multiple-sub" class="cursor-pointer">Subscription</label><br>
 												...
 												<div class=" form-group mb-0 sub-form" style="display: none;">
 													<div class="d-flex align-items-center mb-1">
 														<label class="text-primary fs-16 font-weight-bold mb-0" for="size">Subcription Option: </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 														<a href="#" data-toggle="tooltip" data-placement="top" title="Click to see more Ingredients" class="text-right"> <span data-toggle="modal" data-target="#learnmore_pop">Learn More </span>
 														</a>
