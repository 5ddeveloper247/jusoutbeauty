 ...
 <main ng-app="project1">
     ...
     <section class="py-8 mt-10 store1">
         <div class="container">
             <div class="row">
                 <section class="col-md-6"
                     style="display: flex;
                            ...
                            align-items: center;">
                     <h2 class="mb-2 text-center" data-animate= "fadeInRight" style="color: black">
                         <?php echo isset($categoryName['NAME']) ? $categoryName['NAME'] : 'Store'; ?>
                     </h2>
                     <p class="px-5" style="color:black; text-align:justify">Lorem ipsum dolor sit amet, consectetur
                         adipiscing elit,
                 ...
                 <section class="col-md-6 bg-gray-1 hero-section" style="">
                     <nav aria-label="breadcrumb">
                         <ol class="breadcrumb breadcrumb-site py-0 d-flex justify-content-center fs-15 mb-3">
                             ...
                             <li class="breadcrumb-item d-flex align-items-center"><a class="text-decoration-none"
                                     style="color: white; font-size: 30px"><?php echo isset($subCategoryName['DISPLAY_NAME']) && $subCategoryName['DISPLAY_NAME'] != '' ? $subCategoryName['DISPLAY_NAME'] : $categoryName['NAME']; ?></a>
                             </li>
                         </ol>
                     </nav>
                 </section>
                         ...
                         <div class="card border-0 mb-7">
                             ...
                             <div class="card-body px-0 pt-2 pb-0">
                                 <ul class="list-unstyled mb-0">
                                     ...
                                     <li class="mb-1 d-flex" id="categoryFilter_{{ $filter['SUB_SUB_CATEGORY_ID'] }}">
                                         <input type="checkbox" class="category-filter mr-1"
                                             id="categoryFilterInput_{{ $filter['SUB_SUB_CATEGORY_ID'] }}"
                                             value="{{ $filter['SUB_SUB_CATEGORY_ID'] }}" ng-click="filter();">
                                         <label for="categoryFilterInput_{{ $filter['SUB_SUB_CATEGORY_ID'] }}"
                                             data-toggle="tooltip" data-placement="top"
                                             title="{{ $filter['SUB_CATEGORY_NAME'] }}/{{ $filter['NAME'] }}"
                                             style="white-space: nowrap;overflow: hidden;text-overflow: ellipsis;margin-top: 6px;">
                                             {{ $filter['SUB_CATEGORY_NAME'] }}/{{ $filter['NAME'] }}</label>
                                     </li>
                                     <?php } ?>
                                     <?php } ?>
                                 </ul>
                             ...
                             <div class="card-body px-0 pt-4 pb-0">
                                 <ul class="list-inline mb-0">
                                     <li class="list-inline-item mr-2 mt-2"
                                         ng-repeat="row in displayCollectionShadeFilter" title="@{{ row.TITLE }}">
                                         <a href="javascript:;" class="d-block item shade_filter"
                                             ng-click="shadeFilter(@{{ row.SHADE_ID }});">
         ...
         style="background-color: #68412d;"></a></li> -->
                         ...
                         <div class="card border-0 mb-7">
                             ...
                             <div class="card-body px-0 pt-2 pb-0">
                                 <ul class="list-unstyled mb-0">
                                     <li class="mb-1">
                                         <input type="radio" id="allPricing" name="price" value="all"
                                             ng-click="filter();" checked>
                                         <label for="allPricing"> All</label>
                                     </li>

                                     <li class="mb-1">
                                         <input type="radio" id="price1" name="price" value="10-100"
                                             ng-click="filter();">
                                         <label for="price1"> $10 - $100</label>
                                     </li>

                                     <li class="mb-1">
                                         <input type="radio" id="price2" name="price" value="101-200"
                                             ng-click="filter();">
                                         <label for="price2"> $101 - $200</label>
                                     </li>

                                     <li class="mb-1">
                                         <input type="radio" id="price3" name="price" value="201-300"
                                             ng-click="filter();">
                                         <label for="price3"> $201 - $300</label>
                                     </li>
                                     <li class="mb-1">
                                         <input type="radio" id="price4" name="price" value="301-500"
                                             ng-click="filter();">
                                         <label for="price4"> $301 - $500</label>
                                     </li>
                                     <li class="mb-1">
                                         <input type="radio" id="price5" name="price" value="501-1000"
                                             ng-click="filter();">
                         ...
                         <div class="col-12 pl-0">
                             <a type="button"
                                 ...
                                 ng-click="resetFilter();">Reset Filter</a>
                         </div>
                     </div>
                 </div>
                 <div class="col-xl-12 shop-listing-right-portion">
                     <div class="row">
                         <div class="col-sm-12 mb-4 mb-sm-0 pb-3 sort_inc_shop">
                             ...
                             &nbsp;&nbsp;&nbsp;
                             <div class="dropdown">
                                 <a href="#" class="dropdown-toggle font-weight-500" id="dropdownMenuButton"
                                     data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> Default
                                     Sorting </a>
                                 <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton"
                                     style="">
                                     <a class="dropdown-item text-primary fs-14" href="javascript:;"
                                         ng-click="sortingFilter(1);">Price high to low</a>
                                     <a class="dropdown-item text-primary fs-14" href="javascript:;"
                                         ng-click="sortingFilter(2);">Price low to high</a>
                                     <a class="dropdown-item text-primary fs-14" href="javascript:;"
                                         ng-click="sortingFilter(3);">Random</a>
                                 </div>
                             </div>
                         </div>
                     </div>
                     <div class="row">
                         ...
                         <div class="col-6 col-lg-3 product productshop-listing mb-8"
                             ng-repeat="row in displayCollectionProducts.slice(0, productsToShow)">
                             <div class="card border-0">
                                 <div class="position-relative hover-zoom-in">
                                     ...
                                     <a href="{{ url('/') }}/Products/@{{ row.CATEGORY_SLUG }}/@{{ row.SUB_CATEGORY_SLUG ? row.SUB_CATEGORY_SLUG + '/' : '' }}@{{ row.SLUG }}"
                                         class="d-block overflow-hidden" data-id="@{{ row.PRODUCT_ID }}"
                                         ...
                                         <img src="@{{ row.secondaryImage }}" alt="@{{ row.NAME }}"
                                     ...
                                     <div
                                         ...
                                         <!-- productdetail data-id="@{{ row.PRODUCT_ID }}"-->
                                     ...
                                     <div class="position-absolute pos-fixed-bottom pb-4 px-4 w-100">
                                         <a href="javascript:;"
                                             class="btn btn-white btn-block bg-hover-primary border-hover-primary hover-white @if (isset($userId)) productdetail @else addto-cart @endif"
                                         ...
                                         <a href="javascript:;"
                                             ...
                                             data-id="@{{ row.PRODUCT_ID }}" data-quantity='1'
                                             ng-if="row.INV_QUANTITY_FLAG == 'inv' && row.INV_QUANTITY > '0'">+ Add To
                                             Cart</a>
                                         <a href="javascript:;"
                                             class="btn btn-white btn-block bg-hover-primary border-hover-primary hover-white"
                                             id="qckad"
                                             ng-if="row.INV_QUANTITY_FLAG == 'inv' && row.INV_QUANTITY <= '0'"
                                             disabled>+ Out of Stock</a>
                                     </div>
                                 </div>
                                 <div class="card-body pt-4 px-0 pb-0" data-id="@{{ row.PRODUCT_ID }}"
                                     data-type="@{{ catFlag }}">
                                     <a href="javascript:;"
                                         ...
                                         data-categoryslug="@{{ row.CATEGORY_SLUG }}"> @{{ row.CATEGORY_NAME }} </a>

                                     <h3 class="card-title fs-16 font-weight-500 mb-1 lh-14375 product-heading ">
                                         {{-- productdetail --> removed after made url with href --}}
                                         <a href="{{ url('/') }}/Products/@{{ row.CATEGORY_SLUG }}/@{{ row.SUB_CATEGORY_SLUG ? row.SUB_CATEGORY_SLUG + '/' : '' }}@{{ row.SLUG }}"
                                             class="text-capitalize" data-id="@{{ row.PRODUCT_ID }}"
                                             data-category="@{{ row.CATEGORY_SLUG }}"
                                             data-subCategory="@{{ row.SUB_CATEGORY_SLUG }}"
                                             data-name="@{{ row.SLUG }}"
                                             data-type="@{{ catFlag }}">@{{ row.NAME }}</a>
                                     </h3>
                                     <p class="text-primary mb-0 shop-subtitle card-title cards_length lh-14375 product-subtitle text-capitalize"
                                         style="height: 48px;">@{{ row.SUB_TITLE }}</p>
                                     ...
                                     <div class="row">
                                         <div
                                             ng-class="{'col-sm-7': row.DISC_AMOUNT.length < 6, 'col-sm-6': row.DISC_AMOUNT.length >= 6 || row.UNIT_PRICE <= 0 || row.INV_QUANTITY_FLAG == 'bundle'}">
                                         ...
                                         <div
                                             ng-class="{'col-sm-5': row.DISC_AMOUNT.length < 6, 'col-sm-6': row.DISC_AMOUNT.length >= 6 || row.UNIT_PRICE <= 0 || row.INV_QUANTITY_FLAG == 'bundle'}">
                                             <p
                         ...
                         <div class="col-12 col-lg-12"
                             ng-if="displayCollectionProducts.length == 0 || displayCollectionProducts.length == undefined">
                             <p class="text-center">No record found...</p>
                         </div>
                         <div class="col-12 col-lg-12 text-center mt-4"
                             ng-show="displayCollectionProducts.length > productsToShow">
                         ...
                         <div class="modal fade quick-view " id="productQuickView" tabindex="-1"
                             aria-hidden="true">
                             <div class="modal-dialog quick_view_mbl modal-dialog-scrollable">
                                 <div class="modal-content p-0 quick_view_mbl_carousel_modal">
                                     <div class="modal-body p-0">
                                         <button type="button"
                                             class="close fs-32 pr-0 pt-0 pr-md-3 pt-md-2 position-absolute pos-fixed-top-right z-index-10"
                                         ...
                                         <div class="row no-gutters" id="quick_view_product_details">
                                             <div class="col-sm-6">
                                                 ...
                                                 <div id="carouselExampleControls "
                                                     class="carousel slide quick_view_mbl_carousel"
                                                     ...
                                                     <div class="carousel-inner" ng-show="productImagesLoop != ''">
                                                         <div class="carousel-item @{{ $first == '1' ? 'active' : '' }}"
                                                             ...
                                                             <img class="d-block w-100 quick_view_mbl_carousel_img"
                                                                 style="height:35rem" src="@{{ row.downPath }}"
                                                                 alt="First slide">
                                                         </div>
                                                     </div>
                                                     ...
                                                     <div class="carousel-inner" ng-show="productImagesBundle != ''">
                                                         <div class="carousel-item @{{ $first == '1' ? 'active' : '' }}"
                                                             ng-repeat="row in productImagesBundle">
                                                             <img class="d-block w-100 quick_view_mbl_carousel_img"
                                                                 style="height:35rem" src="@{{ row.DOWN_PATH }}"
                                                                 alt="First slide">
                                                         </div>
                                                     </div>
                                             ...
                                             <div class="col-sm-6 col-md-6 primary-summary "
                                                 style="padding: 15px; height: 35rem; overflow:auto;">
                                                 <div class="d-flex align-items-center">
                                                     <h2 class="fs-24 mb-0">@{{ QuickView_name }}</h2>
                                                 </div>
                                                 <div class="primary-summary-inner" style="padding-bottom: 25px;">
                                                     <p class="text-muted fs-11 font-weight-500 letter-spacing-05px text-uppercase mb-0 pt-1 pb-1"
                                                         ng-show="category_name != ''">
                                                         @{{ category_name }}, @{{ subCategory_name }}</p>
                                                     <p class="text-muted fs-11 font-weight-500 letter-spacing-05px text-uppercase mb-0 pt-1 pb-1"
                                                         ng-show="bundleProductNames != ''">
                   ...
                   class="text-primary fs-12 lh-2"><i
                    class="fas fa-star star_col"></i></span></li>
                                                     ...
                                                     <div style="margin-bottom: 0px;"
                                                         ng-if="displayCollectionProductShadesQuickView != ''">
                                                         <button class="accordion_inc shadeAccord-btn"
                                                             data-id="1">1. Choose Shade</button>
                                                         <div class="panel_inc" id="chooseShade_container_1">
                                                             <div
                                                                 class="form-group shop-swatch-color shop-swatch-color-02 mb-1">
                                                                 <!-- </label> -->
                                                                 <img src="@{{ selectedShadeImg_p }}"
                                                                     alt="Product Image"
                                                                     class="var text-capitalize quick_view_product_image "
                                                                     ng-show="selectedShadeImg_p != ''">
                                                                 <br>
                                                                 ...
                                                                 <input type="hidden" id="prodShadeId"
                                                                     value="">
                                                     ...
                                                     <div class="chooseShade-container" style="margin-bottom: 30px;"
                                                         ng-if="displayCollectionBundleProductShadesQuickView != ''">
                                                         <div id="shadeBundlechooser_container_@{{ row.BUNDLE_LINE_ID }}"
                                                             ng-repeat="row in displayCollectionBundleProductShadesQuickView"
                                                             ng-show='row.productShades != null'>
                                                             <button class="accordion_inc_prod_detail shadeAccord-btn"
                                                                 data-id="@{{ row.BUNDLE_LINE_ID }}">Choose Shade Product
                                                                 @{{ row.productName }}</button><!-- @{{ row.seqNo }}. chooseShadeBtn -->
                                                             <div class="panel_inc_prod_detail"
                                                                 id="chooseShade_container_@{{ row.BUNDLE_LINE_ID }}">
                                                                 <div
                                                                     class="form-group shop-swatch-color shop-swatch-color-02 mb-6 widget-color">

                                                                     <img src="" alt="Product Image"
                                                                         class="var text-capitalize quick_view_product_image bundleLineShadeImg"
                                                                         id="bundleLineShadeImg_@{{ row.BUNDLE_LINE_ID }}"
                                                                         style="display:none;">
                                                                     <br>
                                                                     ...
                                                                     <label class="mb-2">
                                                                         <span
                                                                             class="font-weight-500 text-primary mr-2">Color:</span>
                                                                         <span class="var text-capitalize"
                                                                             id="shadeName1_@{{ row.BUNDLE_LINE_ID }}"></span>
                                                                     </label>
                                                                     <ul
                                                                         class="list-inline d-flex justify-content-start mb-0">
                                                                         <li class="list-inline-item"
                                                                             class="list-inline-item"
                                                                             ng-repeat="list in row.productShades"
                                                                             ...
                                                                             <a href="javascript:;"
                                                                                 class="d-block swatches-item shade_chooser@{{ row.BUNDLE_LINE_ID }}"
                                                                                 id="shadeAnchor_@{{ list.PRODUCT_SHADE_ID }}"
                                                                                 style="background-image: url('@{{ list.shadeprimaryImage }}'); background-repeat:no-repeat;background-position: center;">
                                                                             </a>
                                                                         </li>
                                                                     ...
                                                                     <input type="hidden"
                                                                         id="shadeId_@{{ row.BUNDLE_LINE_ID }}"
                                                                         value="">
                                                                     <input type="hidden"
                                                                         id="prodShadeId_@{{ row.BUNDLE_LINE_ID }}"
                                                                         value="">
                                                                     <input type="hidden"
                                                                         id="shadeName_@{{ row.BUNDLE_LINE_ID }}"
                                                                         value="">
                                                                     <input type="hidden"
                                                                         id="productId_@{{ row.BUNDLE_LINE_ID }}"
                                                                         value="">
                                                                     <input type="hidden"
                                                                         id="shadeExistChk_@{{ row.BUNDLE_LINE_ID }}"
                                                                         value="@{{ (row.productShades.length == 0 || row.productShades.length == undefined) ? 'false' : 'true' }}">
                                                                 </div>
                                                                 <a href="javascript:;" class="btn btn-primary"
                                                                     ng-click="confirmBundleProductShade(@{{ row.BUNDLE_LINE_ID }});">Continue</a>
                                                             </div>
                                                         </div>
                                                     </div>
                                                     ...
                                                     <form>
                                                         ...
                                                         <input type="radio" id="single-sub"
                                                             name="subscriptioncheck" value="One-Time Purchase"
                                                             checked>
                                                         <label for="single-sub" class="cursor-pointer">One-Time
                                                             Purchase</label><br>

                                                         <input type="radio" id="multiple-sub"
                                                             name="subscriptioncheck" value="subscription">
                                                         <label for="multiple-sub"
                                                     ...
                                                     <div class=" form-group mb-0 sub-form" style="display: none;">
                                                         <div class="d-flex align-items-center mb-1">
                                                             ...
                                                             <a href="#" ng-click="showSubscrptionDetailModal()"
                                                                 data-toggle="tooltip" data-placement="top"
                                                                 title="Click to see more Ingredients"
                                                                 class="text-right">Learn More
                                                             </a>
                                                             ...
                                                             <div class="modal fade quick-view" id="learnmore_pop"
                                                                 ...
                                                                 <div class="modal-dialog"
                                                                     ...
                                                                     <div class="modal-content p-0">
                                                                         <div class="modal-body p-0">
                                                                             <button type="button"
                                                                                 class="close fs-32 pr-0 pt-0 pr-md-3 pt-md-2 position-absolute pos-fixed-top-right z-index-10 close_learnmore_pop">
                                                         ...
                                                         <select class="form-control w-100 cursor-pointer"
                                                             id="subsOption" ng-model="subs_id"
                                                             ng-change="fetchSubscriptionDetail();">
                                                             <option value="" class="cursor-pointer">Choose an
                                                                 option</option>
                                                             <option value="@{{ row.ID }}"
                                                                 class="select-subsoptn"
                                                                 ng-repeat="row in subscriptionLov">
                                                                 @{{ row.TITLE }}</option>
                                                         </select>
                                                     </div>
                                                     <form class="cart-roww">
                                                         <div class="row align-items-end no-gutters mx-n2 mb-1">
                                                             <div class="col-sm-3 form-group px-2 mb-0">
                                                                 <label
                                                                     class="text-primary fs-16 font-weight-bold mb-1"
                                                             ...
                                                             <div class="col-sm-8 mb-0 px-2">
                                                                 <button type="button"
                                                                     ...
                                                                     ng-if="QuickView_invQty > '0'">Add to
                                                                     cart</button>
                                                                 <button type="button"
                                                                     class="btn btn-primary btn-block text-capitalize"
                                                                     disabled ng-if="QuickView_invQty <= '0'">Out of
                                                                     Stock</button>
                                                             </div>
                                                         </div>
                                                     </form>
                                                     <p class="text-primary lh-14375 mb-0 sub-line"
                                                         style="display: none;">@{{ subscriptionNote1 }}</p>
                                                     <p class="text-primary lh-14375 mb-0 sub-below-line"
                                                         style="display: none;">@{{ subscriptionNote2 }}</p>
                         ...
                         <div class="modal fade quick-view " id="bundleQuickView" tabindex="-1" aria-hidden="true">
                             <div class="modal-dialog quick_view_mbl modal-dialog-scrollable">
                                 <div class="modal-content p-0 quick_view_mbl_carousel_modal">
                                     <div class="modal-body p-0">
                                         <button type="button"
                                             class="close pr-0 pt-0 pr-md-3 pt-md-2 fs-32 position-absolute pos-fixed-top-right z-index-10"
                                             data-dismiss="modal" aria-label="Close">
                                             <span aria-hidden="true" class="fs-20">
                                                 <i class="fal fa-times"></i>
                                             </span>
                                             ...
                                             <div class="col-sm-6">
                                                 ...
                                                 <div id="carouselExampleControls"
                                                     ...
                                                     <div class="carousel-inner">
                                                         <div class="carousel-item active">
                                                             <img class="d-block w-100 quick_view_mbl_carousel_img"
                                                                 style="height:35rem" src="@{{ bundleImage }}"
                                                                 alt="First slide">
                                                         </div>
                                                     </div>
                                                     <a class="carousel-control-prev" href="#carouselExampleControls"
                                                     ...
                                                     <div class=" form-group mb-0 sub-form" style="display: none;">
                                                         <div class="d-flex align-items-center mb-1">
                                                             ...
                                                             <a href="#" data-toggle="tooltip"
                                                                 data-placement="top"
                                                                 title="Click to see more Ingredients"
                                                                 class="text-right"> <span data-toggle="modal"
                                                                     data-target="#learnmore_pop">Learn More </span>
                                                             </a>
 ...
 <script>
     function close_topbar() {
         ...
         $(".hero-section").addClass('mt-md-10');
