                    ...
                    <div class="col-md-6 col-xl-4 pl-xl-6 pl-md-3 primary-summary summary-sticky" id="summary-sticky">
                        ...
                        <div class="primary-summary-inner" style="padding-right:60px">
                            ...
                            <div class="chooseShade-container" style="margin-bottom: 30px;"
                                ...
                                <button class="accordion_inc_prod_detail shadeAccord-btn" data-id="1"
                                    id="">1. Choose
                                ...
                                <div class="panel_inc_prod_detail" id="chooseShade_container_1">
                                    <div class="form-group shop-swatch-color shop-swatch-color-02 mb-6 widget-color">
                                        ...
                                        <input type="hidden" id="shadeExistChk" value="@{{ (displayCollectionProductShades.length == 0 || displayCollectionProductShades.length == undefined) ? 'false' : 'true' }}">
                                    </div>
                                        ...
                                        <div class="product-hero__icons__image relative">
                                            <div class="img fit-contain is-loaded pos-center">
                                                ...
                                                <img width="70" height="70"
                                                    ...
                                                    title="Clean" data-fit="contain" class="img__el">
                                            </div>
                                        </div>
                ...
                <div class="collapse-tabs">
                    <ul class="nav nav-pills d-md-flex d-block border-bottom" style="display: none !important;"
                        ...
                        <li class="nav-item"><a
                                ...
                                role="tab" aria-controls="pills-description" aria-selected="false">Tab 1</a></li>
                    </ul>
                                            ...
                                            <div class="card-body p-0">
                                                ...
                                                <section class="pb-10 pb-lg-0 mob_tab_sec">
                                                    <div class="">
                                                        ...
                                                        <h4 class="text-center mb-3" style="font-size: 23px;">Backed
                                                            by
                                                            Science to Optimize
                                                            Skin Wellness</h4>
                                                        <ul class="nav nav-pills justify-content-center mb-lg-9 mb-6">
                                                            <li class="nav-item px-5"><a
                                                                    ...
                                                                    id="spotlightTabBtn"
                                                                    style="font-size: 23px !important;">Spotlight
                                                                    Ingredients</a>
                                                            </li>
                                                            <li class="nav-item px-5"><a
                                                                    ...
                                                                    id="formulatedTabBtn"
                                                                    style="font-size: 23px !important;">Formulated
                                                                    Ingredients</a>
                                                            </li>
                                                        </ul>
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="card border-0">
                                                                        ...
                                                                        <img src="<?= $row['DOWN_PATH'] != '' ? $row['DOWN_PATH'] : url('assets-web') . '/images/how-to-step-1.webp' ?>"
                                                                            alt="Image"
                                                                            class="card-img h_to_use_img uses_img">
                                                                        <?php }}?>
        ...
        <section class="py-6 py-lg-6 insta_sec_home">
            <div class="container container-custom container-xl">
                ...
                <div class="slick-slider slick-sliderproductselfi" id="instaFeed_html"
                    ...
                    <div class="box px-1" data-animate="fadeInUp">
                        <a target="_blank"
                            href="<?= isset($selfiimage['DOWN_PATH']) ? $selfiimage['DOWN_PATH'] : '' ?>"
                            class="card hover-zoom-in d-block border-0 hover-change-content insta-secc-home">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 mb-1" style="text-align: center">
                            ...
                            <div class="row register-new-product-picture-para" ng-show="selfi.ID  != ''">
                                ...
                                <form class="" id="uploadattch6" method="POST"
                                    action="{{ url('/uploadProductImageVideoSelfi') }}"
                        ...
                        <div class="col-3 review_sec">
                            <div class="border-right" style="">
                                ...
                                <ul class="list-inline mb-4 d-flex justify-content-center rating-result">
                                    ...
                                    <li class="list-inline-item fs-18 text-primary">
                                        <i class="fas fa-star" style="color: @{{ averageRatingRound >= '2' ? 'black' : 'gray' }};"></i>
                                    </li>
                                    <li class="list-inline-item fs-18 text-primary">
                                        <i class="fas fa-star" style="color: @{{ averageRatingRound >= '3' ? 'black' : 'gray' }};"></i>
                                    </li>
                                    <li class="list-inline-item fs-18 text-primary">
                                        <i class="fas fa-star" style="color: @{{ averageRatingRound >= '4' ? 'black' : 'gray' }};"></i>
                                    </li>
                                    <li class="list-inline-item fs-18 text-primary">
                                        ...
                                        <div class="media-body ">
                                            ...
                                            <div class="" ng-show="row.ANSWER != ''">
                                                <div class="row flex-sm-column-mbl">
                                                    ...
                                                    <div class="col-3 col-md-1 border-left"
                                                        style="border-color: #44B2F7;">
            ...
            <div class="container container-custom container-xxl">
                <ul class="nav nav-pills justify-content-center mb-lg-9 mb-6 last-section-pro-detail" role="tablist">
                    ...
                    <li class="nav-item px-5"><a
                            ...
                            role="tab" aria-controls="pills-recommendations" aria-selected="true">Complete Your
                            JusOGlow</a>
                    </li>
                    <li class="nav-item px-5"><a
                            ...
                            <div class="box px-1" data-animate="fadeInUp">
                                <div class="card border-0 product px-2">
                                    <div class="position-relative">
                                        ...
                                        <a href="{{ url('/') }}/Products/{{ $recommand['CATEGORY_SLUG'] }}/{{ $recommand['SUB_CATEGORY_SLUG'] ? $recommand['SUB_CATEGORY_SLUG'] . '/' : '' }}{{ $recommand['SLUG'] }}"
                                        ...
                                        <div class="position-absolute pos-fixed-bottom pb-4 px-4 w-100">
                                            ...
                                            @if (isset($recommand['productShades']))
                                                <a href="javascript:;"
                                                    ...
                                                    data-subCategory="<?= $recommand['SUB_CATEGORY_SLUG'] ?>"
                                                    data-name="<?= $recommand['SLUG'] ?>"
                                                    data-type="@{{ catFlag }}">+ Add To Cart</a>
                                            @elseif($recommand['INV_QUANTITY_FLAG'] == 'inv' && $recommand['INV_QUANTITY'] > 0)
                                                <a href="javascript:;"
                                                    ...
                                                    data-id="<?= $recommand['PRODUCT_ID'] ?>" data-quantity='1'>+
                                                    Add To Cart</a>
                                    ...
                                    <div class="card-body pt-4 px-0 pb-0">
                                        ...
                                        <div class="row">
                                            <div
                                                class="@if (strlen($recommand['DISC_AMOUNT'] < 6)) col-sm-6 @else col-sm-7 @endif col-9 d-flex justify-content-evenly">
                                                @if ($recommand['DISC_AMOUNT'] > 0)
                                                    <p class="text-primary mb-0 card-title lh-14375">
                                                        ${{ $recommand['DISC_AMOUNT'] }}</p>
                                                    <small class="ml-1 mt-1 lh-14375"><del>
                                                            ${{ $recommand['UNIT_PRICE'] }}</del></small>
                                                @else
                                                    <p class="text-primary mb-0 card-title lh-14375">
                                            ...
                                            <div
                                                class="@if (strlen($recommand['DISC_AMOUNT'] < 6)) col-sm-6 @else  col-sm-5 @endif col-3">
                                                <p
                                                    class="text-primary mb-0 card-title lh-14375 text-right text-right-sm ellipsis">
                                                    {{ $recommand['UNIT'] }}</p>
                                            </div>
                        ...
                        <div class="slick-slider "
                            ...
                            <div class="box px-1" data-animate="fadeInUp">
                                <div class="card border-0 product px-2">
                                    <div class="position-relative">
                                        {{-- productdetail --> removed after made url with href --}}
                                        <a href="{{ url('/') }}/Products/{{ $recent['CATEGORY_SLUG'] }}/{{ $recent['SUB_CATEGORY_SLUG'] ? $recent['SUB_CATEGORY_SLUG'] . '/' : '' }}{{ $recent['SLUG'] }}"
                                            class="d-block overflow-hidden" data-id="<?= $recent['PRODUCT_ID'] ?>"
                                            data-category="<?= $recent['CATEGORY_SLUG'] ?>"
                                            data-subCategory="<?= $recent['SUB_CATEGORY_SLUG'] ?>"
                                            data-name="<?= $recent['SLUG'] ?>"
                                            data-type="<?= $recent['CATEGORY_NAME'] ?>">
                                        ...
                                        <div class="position-absolute pos-fixed-bottom pb-4 px-4 w-100">
                                            ...
                                            @elseif($recent['INV_QUANTITY_FLAG'] == 'inv' && $recent['INV_QUANTITY'] > 0)
                                                <a href="javascript:;"
                                                    class="btn btn-white btn-block bg-hover-primary border-hover-primary hover-white addto-cart1"
                                                    id="qckad" data-type="@{{ productType }}"
                                                    data-id="<?= $recent['PRODUCT_ID'] ?>" data-quantity='1'>+ Add
                                                    To Cart</a>
                                    ...
                                    <div class="card-body pt-4 px-0 pb-0">
                                        ...
                                        <div class="d-flex flex-column mb-2">
                                            <h3 class="card-title fs-16 font-weight-500 mb-0 lh-14375 ellipsis">
                                                {{-- productdetail --> removed after made url with href --}}
                                                <a href="{{ url('/') }}/Products/{{ $recent['CATEGORY_SLUG'] }}/{{ $recent['SUB_CATEGORY_SLUG'] ? $recent['SUB_CATEGORY_SLUG'] . '/' : '' }}{{ $recent['SLUG'] }}"
                                                    class="" data-id="<?= $recent['PRODUCT_ID'] ?>"
                                                    data-category="<?= $recent['CATEGORY_SLUG'] ?>"
                                                    data-subCategory="<?= $recent['SUB_CATEGORY_SLUG'] ?>"
                                                    data-name="<?= $recent['SLUG'] ?>"
                                        ...
                                        <div class="row">
                                            <div
                                                class="@if (strlen($recent['DISC_AMOUNT'] < 6)) col-sm-6 @else col-sm-7 @endif col-9 d-flex justify-content-evenly">
                                                @if ($recent['DISC_AMOUNT'] > 0)
                                                    <p class="text-primary mb-0 card-title lh-14375">
                                                        ${{ $recent['DISC_AMOUNT'] }}</p>
                                                    <small class="ml-1 mt-1 lh-14375"><del>
                                                            ${{ $recent['UNIT_PRICE'] }}</del></small>
                                                @else
                                                    <p class="text-primary mb-0 card-title lh-14375">
                                                        ${{ $recent['UNIT_PRICE'] }}</p>
                                                @endif
                                            ...
                                            <div
                                                class="@if (strlen($recent['DISC_AMOUNT'] < 6)) col-sm-6 @else  col-sm-5 @endif col-3">
                                                <p
                                                    class="text-primary mb-0 card-title lh-14375 text-right text-right-sm ellipsis">
                                                    {{ $recent['UNIT'] }}</p>
                                            </div>
                                ...
                                <div class="row no-gutters" id="quick_view_product_details">
                                    <div class="col-sm-6">
                                        ...
                                        <div id="carouselExampleControls"
                                            class="carousel slide quick_view_mbl_carousel" data-ride="carousel"
                                            data-interval="2000">
                            ...
                            <a href="store.html" class="btn btn-primary">Continue</a>
                                            ...
                                            <div class=" form-group mb-0 sub-form" style="display: none;">
                                                ...
                                                <select class="form-control w-100 cursor-pointer" id="subsOption"
                                                    ...
                                                    <option value="@{{ row.ID }}" class="select-subsoptn"
                                                        ng-repeat="row in subscriptionLov">@{{ row.TITLE }}
                                                    </option>
                                                </select>
                                            </div>
                                                    ...
                                                    <div class="col-sm-3 form-group px-2 mb-0">
                                                        ...
                                                        <div class="input-group position-relative w-100">
                                                            <a href="javascript:;"
                                                                class="down position-absolute pos-fixed-left-center pl-2 z-index-2 addsubquantity">
                                                                <i class="far fa-minus"></i>
                                                            </a> <input name="number" type="number"
                                                                id="quantity"
                                                                class="form-control w-100 px-6 text-center input-quality bg-transparent text-primary quantityinput"
