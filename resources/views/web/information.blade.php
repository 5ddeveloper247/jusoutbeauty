...
//         }, 2000);
//     });
    // $("#v-pills-profile-tab-1").click(function() {
    //     $('#information-page').text('Privacy Policy');
    // });
    // $("#v-pills-messages-tab-2").click(function() {
    //     $('#information-page').text('Accessibility');
    // });
    // $("#v-pills-settings-tab-3").click(function() {
    //     $('#information-page').text('Cookies Settings/Policy');
    // });
    // $("#ship").click(function() {
    //     $('#information-page').text('Shipping & Returns');
    // });
    // $("#track").click(function() {
    //     $('#information-page').text('Track Order');
    // });
    // $("#account").click(function() {
    //     $('#information-page').text('My Accounts');
    // });
</script>
