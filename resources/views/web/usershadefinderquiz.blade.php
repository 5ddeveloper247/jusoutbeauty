...
<!-- nav-item -->
                               <ul class="nav nav-pills d-md-flex border-bottom slick-slider11" id="pills-tab">

							   <li class="nav-item quiz_nav_links mb-3 mx-1 px-0" >
								...
								<li class="nav-item quiz_nav_links mb-3 mx-1 px-0" ng-repeat="row in displayCollectionLevelOneTypesOptions">
									<a class="nav-link yeslevelonetabs cursor-pointer show font-weight-600 px-0 pb-3 mr-md-6 mr-4 text-active-primary border-active-primary bg-transparent rounded-0 lh-14375"
										...
										<div class="shade-finder-slider bg-white-md shadow-none pt-2 pt-md-2 pt-lg-1 px-0 mt-2">
																...
																<div class="slick-slider1 shadefinder">
																	...
																	<div class="px-1 div-boxx shade" ng-repeat="row in displayCollectionLevelOneTypes" >
																		...
																		<a href="javascript:;" ng-repeat="image in row.images" class="card shadee border-0 hover-change-content insta-secc insta-section-image submit-btn">
																			...
																			{{-- <img src="http://www.jusoutbeauty.com/public/uploads/shadefinder/46.jpg" alt="alt" class="card-img" width="445" height="411"> --}}
																		</a>
																...
																<div class=" shadefinder" >
																	...
																	<div class="px-1 div-boxx shade single-tabss shade-type" >
																		...
																		<a href="javascript:;" ng-repeat="img in row.images" class="card shadee border-0 hover-change-content insta-secc insta_section_shade_finder insta-section-image submit-btn">
																			...
																			{{-- <img src="http://www.jusoutbeauty.com/public/uploads/shadefinder/46.jpg" alt="alt" class="card-img objectfit-cover"> --}}
																		</a>
