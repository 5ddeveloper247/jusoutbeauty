             ...
             <div class="row">
                 <section class="col-md-6"
                     ...
                     <h2 class="mb-2 text-center" data-animate= "fadeInRight" style="color:black;">
                         <?php echo isset($categoryName['NAME']) ? $categoryName['NAME'] : 'Store'; ?></h2>
                     ...
                     <nav aria-label="breadcrumb">
                         <ol class="breadcrumb breadcrumb-site py-0 d-flex justify-content-center fs-15 mb-3">
                             ...
                             <li class="breadcrumb-item d-flex align-items-center"><a class="text-decoration-none"
                                     style="color: white; font-size: 30px">Shop All</a>
                             </li>
                         </ol>
                     </nav>
                 </section>
                         ...
                         <div class="card border-0 mb-7">
                             ...
                             <div class="card-body px-0 pt-2 pb-0">
                                 <ul class="list-unstyled mb-0">
                                     ...
                                     <li class="mb-1 d-flex" id="categoryFilter_@{{ row.SUB_SUB_CATEGORY_ID }}"
                                         ng-repeat="row in displayCollectionSubCategoryFilter">
                                         <input type="checkbox" class="category-filter mr-1"
                                             id="categoryFilterInput_@{{ row.SUB_SUB_CATEGORY_ID }}"
                                             value="@{{ row.SUB_SUB_CATEGORY_ID }}" ng-click="filter();">
                                         <label for="categoryFilterInput_@{{ row.SUB_SUB_CATEGORY_ID }}" data-toggle="tooltip"
                                             data-placement="top"
                                             title="@{{ row.CATEGORY_NAME }}/@{{ row.SUB_CATEGORY_NAME }}/@{{ row.NAME }}"
                                             style="white-space: nowrap;overflow: hidden;text-overflow: ellipsis;margin-top: 6px;">
                                             @{{ row.CATEGORY_NAME }}/@{{ row.NAME }}</label>
                                     </li>

                                     <li class="mb-1 text-center" id=""
                                         ng-click="loadMoreSubCategoriesFilter();" ng-show="hideLoadMore == '0'">
                                         <label
                                             style="white-space: nowrap;overflow: hidden;text-overflow: ellipsis;margin-top: 6px;">
                                             Load More...</label>
                                     </li>
                             ...
                             <div class="card border-0">
                                 ...
                                 <div class="card-body pt-4 px-0 pb-0">
                                     <a href="javascript:;"
                                         ...
                                         data-categoryslug="@{{ row.CATEGORY_SLUG }}"> @{{ row.CATEGORY }} </a>
                                     ...
                                     <div class="row">
                                         <div
                                             ng-class="{'col-sm-6': row.DISC_AMOUNT.length < 6, 'col-sm-7': row.DISC_AMOUNT.length >= 6 || row.UNIT_PRICE <= 0}">
                                         ...
                                         <div
                                             ng-class="{'col-sm-6': row.DISC_AMOUNT.length < 6, 'col-sm-5': row.DISC_AMOUNT.length >= 6 || row.UNIT_PRICE <= 0}">
                                             <p
                                         ...
                                         <div class="row no-gutters" id="quick_view_product_details">
                                                 ...
                                                 <div id="carouselExampleControls"
                                                     ...
                                                     <div class="carousel-inner" ng-show="productImagesBundle != ''">
                                                         <div class="carousel-item active">
                                                             <img class="d-block w-100 quick_view_mbl_carousel_img"
                                                                 style="height:35rem" src="@{{ productImagesBundle }}"
                                                                 alt="First slide">
                                                         </div>
                                                     </div>
                                             ...
                                             <div class="col-sm-6 col-md-6 primary-summary " style="padding: 15px;">
                                                 ...
                                                 <div class="primary-summary-inner"
                                                     style="max-height: 31rem;overflow: scroll;padding-bottom: 25px;">
                                                     ...
                                                     <div class="chooseShade-container" style="margin-bottom: 30px;"
                                                         ...
                                                         <div id="shadeBundlechooser_container_@{{ row.BUNDLE_LINE_ID }}"
                                                             ...
                                                             <button class="accordion_inc_prod_detail shadeAccord-btn"
                                                                 data-id="@{{ row.BUNDLE_LINE_ID }}">@{{ row.seqNo }}.
                                                                 Choose Shade Product
                                                                 @{{ row.productName }}</button><!-- chooseShadeBtn -->
                                                         ...
                                                         <div class="row align-items-end no-gutters mx-n2 mb-1">
                                                             ...
                                                             <div class="col-sm-8 mb-0 px-2">
                                                                 ...
                                                                 <a href="javascript:;"
                                                                     ...
                                                                     id="qckad" data-id="@{{ row.PRODUCT_ID }}"
                                                                     data-type="@{{ productType }}"
                                                                     ng-if="productInventry == 'shade' || productInventry == 'bundle'">+
                                                                     Add To Cart</a>
                                                                 <a href="javascript:;"
                                                                     class="btn btn-white btn-block bg-hover-primary border-hover-primary hover-white addto-cart1"
                                                                     id="qckad"
                                                                     ...
                                                                     data-quantity='1'
                                                                     ng-if="productInventry == 'inv' && productInventryQuantity > '0'">+
                                                                     Add To Cart</a>
                                                                 <a href="javascript:;"
                                                                     class="btn btn-white btn-block bg-hover-primary border-hover-primary hover-white"
                                                                     id="qckad"
                                                     ...
                                                     <div class="carousel-inner">
                                                         <div class="carousel-item active">
                                                             <img class="d-block w-100" style="height:35rem"
                                                                 src="@{{ bundleImage }}" alt="First slide">
                                                         </div>
                                                     </div>
                                                     <a class="carousel-control-prev" href="#carouselExampleControls"
                                                         role="button" data-slide="prev">
                                                         ...
                                                         <div class="row align-items-end no-gutters mx-n2 mb-1">
                                                             ...
                                                             <div class="col-sm-8 mb-0 px-2">
                                                                 <button type="button"
                                                                     ...
                                                                     data-type="@{{ productType }}"
                                                                     data-id="@{{ QuickView_productId }}"
                                                                     data-quantity='1' data-subs='1'>Add to
                                                                     cart</button>
                                                             </div>
                                                         </div>
                                                     </form>
