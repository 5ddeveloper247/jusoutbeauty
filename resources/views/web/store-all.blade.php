                            ...
                            <div class="card border-0">
 								<div class="position-relative hover-zoom-in">
 									...
 									<div class="position-absolute pos-fixed-bottom pb-4 px-4 w-100">
 										<a href="javascript:;" class="btn btn-white btn-block bg-hover-primary border-hover-primary hover-white @if(isset($userId)) productdetail @else addto-cart1 @endif" id="qckad" data-id="@{{row.PRODUCT_ID}}" data-category="@{{ row.CATEGORY_SLUG }}" data-subCategory="@{{ row.SUB_CATEGORY_SLUG }}" data-name="@{{ row.SLUG }}" data-type="@{{catFlag}}" ng-if="row.INV_QUANTITY_FLAG == 'shade' || row.INV_QUANTITY_FLAG == 'bundle'">+ Add To Cart</a>
 												...
 												<form class="cart-roww">
 													<div class="row align-items-end no-gutters mx-n2 mb-1">
 														...
 														<div class="col-sm-8 mb-0 px-2">
															...
															<a href="javascript:;" class="btn btn-white btn-block bg-hover-primary border-hover-primary hover-white @if(isset($userId)) productdetail @else addto-cart1 @endif" id="qckad" data-id="@{{row.PRODUCT_ID}}" data-type="@{{productType}}" ng-if="productInventry == 'shade' || productInventry == 'bundle'">+ Add To Cart</a>
															<a href="javascript:;" class="btn btn-white btn-block bg-hover-primary border-hover-primary hover-white addto-cart1" id="qckad" data-type="@{{productType}}" data-id="@{{row.PRODUCT_ID}}" data-quantity='1' ng-if="productInventry == 'inv' && productInventryQuantity > '0'">+ Add To Cart</a>
