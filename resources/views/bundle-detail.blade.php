            ...
            <div class="container container-custom container-xxl mt-5 mt-md-0 mt-xl-5 mt-xxl-5">
                <div class="row no-gutters">
                        ...
                        <div class="row no-gutters mx-n1">
                            ...
                            <div class="col-sm-6 col-6 px-1 mb-2" ng-show="selectedShadeImg_p != ''"
                                ...
                                <img src="@{{ selectedShadeImg_p }}" alt="Image"
                                    class="prod_img_detail img-w25 img-product-gall">
                            </div>
                            ...
                            <div class="col-sm-6 col-6 px-1 mb-2">
                                <img src="<?= $bundleDetails['primaryImage'] ?>" alt="Image"
                                    class="prod_img_detail img-product-gall">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-xl-4 pl-xl-6 pl-md-3 primary-summary summary-sticky" id="summary-sticky"
                        ...
                        <div class="primary-summary-inner" style="">
         ...
         <a href="javascript:;" class="btn btn-primary">Continue</a>
                            ...
                            <form>
                                ...
                                <input type="radio" id="single-sub" name="subscriptioncheck"
                                    value="One-Time Purchase" checked>
                                <label for="single-sub">One-Time Purchase</label><br>

                                <input type="radio" id="multiple-sub" name="subscriptioncheck"
                                    value="subscription">
                            ...
                            <div class=" form-group mb-7 sub-form" style="display: none;">
                                <div class="d-flex align-items-center mb-3">
                                    ...
                                    <a href="javascript:;" data-toggle="tooltip" data-placement="top"
                                        ...
                                        </span><!-- data-toggle="modal" data-target="#learnmore_pop" -->
                                    </a>
                                ...
                                <select class="form-control w-100" id="subsOption" ng-model="subs_id"
                                ...
                                <div class="row align-items-end no-gutters mx-n2">
                                    ...
                                    <div class="col-sm-8 mb-6 px-2">
                                        <button type="button"
                                            ...
                                            data-type="bundle"
                                            data-id="<?= isset($bundleDetails['BUNDLE_ID']) ? $bundleDetails['BUNDLE_ID'] : '' ?>"
        ...
        <section class="pb-11 pb-lg-6">
            <div class="container container-custom">
                <div class="collapse-tabs">
                    <ul class="nav nav-pills d-md-flex d-block border-bottom" id="pills-tab" role="tablist">
                        ...
                        <li class="nav-item"><a
                                ...
                                aria-controls="pills-tabs-<?= $line['BUNDLE_LINE_ID'] ?>"
                                aria-selected="false"><?= $line['NAME'] ?></a></li>
                        <?php $i++;}?>
                        <?php }?>
                    ...
                    <div class="tab-content bg-white-md shadow-none pt-md-7 px-0 m-0">
                        ...
                        {"breakpoint": 576,"settings": {"slidesToShow": 1}}]}'>
                                                            ...
                                                            <div class="product-hero__icons__image relative">
                                                                <div class="img fit-contain is-loaded pos-center">
                                                                    ...
                                                                    <div class="skeleton"></div> <img
                                                                        ...
                                                                        alt="Clean" title="Clean"
                                                                        data-fit="contain" class="img__el">
                                                                </div>
                                                            </div>
                                                            <span
                                                                class="product-hero__icons__text">{{ ucfirst(substr($row['TITLE'], 0, 10)) }}</span>
                                                        </li>
                                                    </div>
                                                </a>
                                            </div>
                            ...
                            <div class="tab-pane tab-pane-parent fade <?php echo $i == 0 ? 'show active' : ''; ?>"
                                id="pills-tabs-<?= $line['BUNDLE_LINE_ID'] ?>" role="tabpanel">
                                <div class="card border-0 bg-transparent">
                                    <div class="card-header border-0 bg-transparent d-none px-0 py-1"
                                    ...
                                    <div id="description-collapse-01"
                                        class="collapsible collapse <?php echo $i == 0 ? 'show' : ''; ?>"
                                                ...
                                                <section class="pt-10 pt-lg-8 py-8">
                                                    <div class="">
                                                        <div class="row no-gutters align-items-center">
                                                            ...
                                                            <div class="col-md-4 pl-7 scroll-to-see"
                                                                style="height:40rem;overflow-y:auto">
                                                                <h3 class="fs-35 mb-5">
                                                                    <?= isset($line['videoDetails']['V_1']) ? $line['videoDetails']['V_1'] : '' ?>
                                                                </h3>
                                                                <p><?= isset($line['videoDetails']['V_2']) ? $line['videoDetails']['V_2'] : '' ?>
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="container container-custom container-xxl">
                                                        ...
                                                        <ul class="nav nav-pills justify-content-center mb-lg-9 mb-6">
                                                            <li class="nav-item px-5"><a
                                                                    ...
                                                                    data-id="<?= $line['BUNDLE_LINE_ID'] ?>">Spotlight
                                                                    Ingredients</a></li>
                                                            <li class="nav-item px-5"><a
                                                                    ...
                                                                    data-id="<?= $line['BUNDLE_LINE_ID'] ?>">Formulated
                                                                    Ingredients</a></li>
                                                        </ul>
                                                        <div class="p-0 m-0" id="pills-tabContent">
                                                            <div class="tabbspotlight"
                                                                id="tabbspotlight<?= $line['BUNDLE_LINE_ID'] ?>">
                                                                    ...
                                                                    <div class="container container-custom">
                                                                        <div class="row">
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <img class="img-h30 spot-section-img"
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <a href="javascript:;"
                                                                                    ...
                                                                                    <span data-toggle="modal"
                                                                                        data-target="#ingred_pop<?= $line['BUNDLE_LINE_ID'] ?>">List
                                                            ...
                                                            <div class="tabbformulated"
                                                                id="tabbformulated<?= $line['BUNDLE_LINE_ID'] ?>"
                                                                style="display: none;">
                                                                <section class="pb-11 pb-lg-0" id="">
                                                                    <div class="container container-custom">
                                                                        <div class="row">
                                                                            ...
                                                                            <div
                                                                                class="col-sm-6 col-lg-3 mb-6 mb-lg-0 ing_sec_inc_prod_detail pt-5 pb-5 spot-section">
                                                                                <img class="img-h25 spot-section-img"
                                                                                    src="<?= isset($row['image']['downPath']) ? $row['image']['downPath'] : url('assets-web') . '/images/cannabis-ingredient.webp' ?>">
                                                                                <p
                                                                                    class="text-primary font-weight-500 lh-14375 mb-3 pt-4 ">
                                                                                    <?= $row['INGREDIENT_NAME'] ?></p>
                                                            ...
                                                            <div class="modal fade quick-view"
                                                                id="ingred_pop<?= $line['BUNDLE_LINE_ID'] ?>"
                                                    ...
                                                    <div class="container container-custom p-0">
                                                        <div class="row no-gutters align-items-center">
                                                            <div class="col-md-6 mb-8 mb-md-0 hover-zoom-in">
                                                                ...
                                                                <img src="{{ url('assets-web') }}/images/img-video.jpg"
                                                                    alt="Clinical Note">

                                                                <?php }?>
                                                            </div>
                                                            <div class="col-md-6 px-md-6 pl-xl-7 pr-xl-7 scroll-to-see"
                                                                style="">
                                        ...
                                        <section class="py-6 py-lg-10 insta_sec_home">
                                            <div class="container container-custom container-xl">
                                                ...
                                                <p class="text-center mb-3 mx-auto">
                                                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Ad odit est
                                                    aspernatur quaerat a tempore?
                                                    Obcaecati voluptatem pariatur ab dolor laborum, a incidunt quisquam
                                                    illo accusantium alias hic
                                                    molestiae eius quasi, fugit expedita ut minus, delectus animi vero
                                                    magnam accusamus numquam ipsum
                                                    atque. Fugiat hic,
                                                </p>
                                                <div class="text-center mb-9">
                                                    <a href="javascript:;" class="preview btn btn-primary"
                                                        data-toggle="modal" data-target="#productselfi">
                                                ...
                                                <div class="slick-slider slick-sliderproductselfi" id="instaFeed_html"
                                                    ...
                                                    <div class="box px-1" data-animate="fadeInUp">
                                                        <a href=""
                                                            ...
                                                            <img src="<?= isset($selfiimage['DOWN_PATH']) ? $selfiimage['DOWN_PATH'] : '' ?>"
                                                                alt="" class="card-img insta-secc-home">
                                                        </a>
                                                    </div>
                                                    <?php }else{ ?>
                                                    <div class="box px-1" data-animate="fadeInUp">
                                                        <a href="<?= isset($selfiimage['DOWN_PATH']) ? $selfiimage['DOWN_PATH'] : '' ?>"
                                                            ...
                                                            <video width="400" controls>
                                                                <source
                                                                    src="<?= isset($selfiimage['DOWN_PATH']) ? $selfiimage['DOWN_PATH'] : '' ?>"
                                                                    type="video/mp4">
                                                                <source
                                                                    src="<?= isset($selfiimage['DOWN_PATH']) ? $selfiimage['DOWN_PATH'] : '' ?>"
                                                                    type="video/ogg">
                                            ...
                                            <div class="modal fade selfi-view" id="productselfi" tabindex="-1"
                                                aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content p-0">
                                                        ...
                                                        <div class="modal-body ">
                                                            ...
                                                            <div ng-show="selfi.ID == ''">
                                                                <label
                                                                    style=" display: block !important;text-align:left;">Enter
                                                                    your name</label>
                                                                <input type="text" id="name" name="name"
                                                                    ng-model="selfi['name']" class="form-control mb-3"
                                                                    placeholder="Name">

                                                                <label style=" display: block;text-align:left;">Enter
                                                                    your email</label>
                                                                <input name="email" type="email"
                                                                    ng-model="selfi['email']" id="email"
                                                            ...
                                                            <div class="row register-new-product-picture-para"
                                                                ng-show="selfi.ID  != ''">
                                                                <div class="col-1"></div>
                                                                <div class="col-sm-3 image-overlay upload-photo-box"
                                                                    id="imageAttach-btn" onclick="form2();"
                                                                    style="">
                                                                ...
                                                                <form class="" id="uploadattch6" method="POST"
                                                                    action="uploadProductImageVideoSelfi"
                                                                    ...
                                                                    <input type="hidden" id="sourceId"
                                                                        name="sourceId"
                                                                        value="@{{ selfi.ID }}">
                                                                    <input type="file" id="uploadatt6"
                                                                        name="uploadatt6" class="file-input"
                                                                        style="display: none;">
                                                                </form>

                                                            </div>
                                                            <button type="submit"
                                                                class="btn btn-primary btn-block savebtn"
                                                                ng-click="submitProductSelfi();">Submit</button>
                                                            <button type="button"
                                                                class="btn btn-primary btn-block loaderbtn" disabled
                                                                style="display: none"><i
                                                                    class="ft-rotate-cw spinner"></i>
                                                                Processing</button>
                    ...
                    <div class="row">
                        ...
                        <div class="col-3 review_sec p-0">
                            ...
                            <div class="mt-6 mt-md-10">
                                <a href="javascript:;" style="font-size: .8rem;"
                                    class="btn btn-outline-primary rev-btnns" id="writeReview_btn">Write a Review</a>
                            ...
                            <div class="card-body p-0">
                                ...
                                <form>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <div class="form-group mb-6">
                                                ...
                                                <input type="radio" id="skintype1" name="skintype"
                                                    value="Balanced">
                                                ...
                                                <input type="radio" id="skintype4" name="skintype"
                                                    value="combination">
                                                <label for="skintype4"> Combination</label><br>

                                                <input type="radio" id="skintype5" name="skintype"
                                                    value="Sensitive">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="form-group mb-6">
                                                ...
                                                <input type="radio" id="recommand1" name="recommand"
                                                    value="Yes">
                                                <label for="recommand1">Yes</label><br>

                                                <input type="radio" id="recommand2" name="recommand"
                                                    value="No">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group mb-6">
                                                <input placeholder="Use your name:*" class="form-control"
                                                    type="text" name="name" ng-model="review['R_10']">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group mb-6">
                                                <input type="email" placeholder="Email*" name="email"
                                                    class="form-control" ng-model="review['R_11']">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="text-center">
                                        <button type="button" class="btn btn-primary"
                                            ng-click="postReview();">Post</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                                ...
                                <div class="comment-product mw-900 mx-auto">
                                    ...
                                    <div class="container container-custom">
                                        <div class="row border-bottom mb-2"
                                            ng-repeat="row in displayCollectionReviews">
                                                    ...
                                                    <div class="media-body text-center-mbl">
                                                        <div
                                                            ...
                                                            <ul class="list-inline mb-0 mr-auto d-flex col-sm-12">
                                                                ...
                                                                <li class="list-inline-item fs-12 text-primary"
                                                                    ng-if="row.STAR_RATING == '2'"
                                                                    style="width:100%;">
                                                                    <i class="fas fa-star"></i> <i
                                                                        class="fas fa-star"></i>
                                                                </li>
                                                                <li class="list-inline-item fs-12 text-primary"
                                                                    ng-if="row.STAR_RATING == '1'"
                                                                    style="width:100%;">
                                                                    <i class="fas fa-star"></i>
                                                                </li>
                                                            ...
                                                            <p class="text-primary mb-0">
                                                                <span
                                                                    class="font-weight-500 text-primary d-inline-block">
                                                                ...
                                                                <span class="fs-14 d-inline-block"><b>Murad
                                                                        Recommendation:</b>
                                ...
                                <form>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group mb-6">
                                                <input placeholder="Use your name:*" class="form-control"
                                                    type="text" ng-model="question['Q_1']">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group mb-6">
                        ...
                        <section class=" pb-lg-13">
                            <div class="container container-custom">
                                <div class="comment-product mw-900 mx-auto">
                                    ...
                                    <div class="media border-bottom pb-7 mb-7 "
                                        ng-repeat="row in displayCollectionQuestions">
                                        <div class="w-70px d-block mr-6">
                                            <img class="img-round-50"
                                                src="{{ url('/assets-web') }}/images/test-img.jpg" alt="Dean. D">
                                        </div>
        ...
        <section class="pb-10 pb-lg-13">
            <div class="container container-custom container-xxl">
                ...
                <div class="tab-content p-0 m-0 shadow-none" id="pills-tabContent">
                    ...
                    <div class="tab-pane fade show active" id="pills-recommendations" role="tabpanel"
                                        ...
                                        <div
                                            ...
                                            <div class="content-change-vertical d-flex flex-column ml-auto">
                                                <a href="javascript:;" data-toggle="tooltip" data-placement="left"
                                                    ...
                                                    data-productId="<?= $recommand['PRODUCT_ID'] ?>"
                                                    data-type='single'>
                                                    <i
                                    ...
                                    <div class="card-body pt-4 px-0 pb-0">
                                        ...
                                        <ul class="list-inline mb-0 shop-swatch-color-03 d-flex align-items-center">
                                            ...
                                            <li class="list-inline-item" title="<?= $shade['SHADE_NAME'] ?>">
                                                <a href="javascript:;" class="d-block swatches-item shade_chooser"
          ...
          <ul
           ...
           <li class="list-inline-item"><a href="#"
            ...
            title="green-revitalizing" style="background-color: #B66262;">
                    ...
                    <div class="tab-pane fade " id="pills-recently-viewed" role="tabpanel"
                        aria-labelledby="pills-recently-viewed-tab">
                        <div class="slick-slider "
                            data-slick-options='{"slidesToShow": 4, "autoplay":false,"dots":true,"arrows":false,"responsive":[{"breakpoint": 992,"settings": {"slidesToShow":3}},{"breakpoint": 768,"settings": {"slidesToShow": 2}},{"breakpoint": 576,"settings": {"slidesToShow": 1}}]}'>
               ...
               data-target="#product-recommendations-1"> <i
                class="fal fa-eye"></i>
                        ...
                        <div class="modal fade quick-view" id="product-recently-viewed-1" tabindex="-1"
                            aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content p-0">
                                    <div class="modal-body p-0">
                                        ...
                                        <div class="row no-gutters">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="p-3 py-lg-8 pl-lg-8 pr-lg-7">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <h2 class="fs-30 mb-1">
                                                            <a href="product-detail-01.html">Hoodie with pouch
                                                                pocket</a>
                                                        </h2>
                                                    </div>
                                                    <p class="mb-6 fs-20 text-primary lh-14">$79.00</p>
                ...
                <div class="modal-content p-0">
                    ...
                    <div class="modal-body ">
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 mb-1" style="text-align: center">
                                <img src="{{ url('/assets-web') }}/images/default-selfi.jpg"
                                    onclick="showfileload()" id="hung221" alt="" class="selfi-img"
                                    style="">
                            </div>
                            <div class="col-xl-12 col-lg-12 col-md-12 mb-1" style="text-align: center">
                                <img src="" id="hung22" alt="" onclick="showfileload()"
                                    class="selfi-img" style="display:none;">
                            </div>
                        ...
                        <form action="{{ route('saveProductSelfie') }}" method="POST" id="saveProductSelfie">
                            ...
                            <input name="file" onchange="loadFile(event)" type="file"
                                class="form-control mb-3" placeholder="UPLOAD YOUR SELFIE" id="selfie_img">
