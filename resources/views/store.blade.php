 ...
 <main ng-app="project1">
     <section class="py-10 mt-15 mt-15-67 bg-gray-1 hero-section">
         <div class="container">
             <h2 class="mb-2 text-center banner-font" data-animate= "fadeInRight" style="color: white"><?php echo isset($categoryName['NAME']) ? $categoryName['NAME'] : 'Store'; ?>
             </h2>
             <nav aria-label="breadcrumb">
                 <ol class="breadcrumb breadcrumb-site py-0 d-flex justify-content-center fs-15 mb-3">
                     <li class="breadcrumb-item"><a class="text-decoration-none" href="{{ session('site') }}/home"
                             style="color: white; font-size: 30px">Home</a></li>
                     <li class="breadcrumb-item d-flex align-items-center"><a class="text-decoration-none"
                             style="color: white; font-size: 30px"><?php echo isset($subCategoryName['NAME']) && $subCategoryName['NAME'] != '' ? $subCategoryName['NAME'] : $categoryName['NAME']; ?></a>
                     </li>
                 </ol>
             </nav>
         </div>
                 ...
                 <div class="col-xl-12 shop-listing-right-portion">
                     ...
                     <div class="row">
                         <div class="col-6 col-lg-3 product productshop-listing mb-8"
                             ng-repeat="row in displayCollectionProducts">
                             <div class="card border-0">
                                 <div class="position-relative hover-zoom-in">
                                     <a href="javascript:;" class="d-block overflow-hidden productdetail"
                                         data-id="@{{ row.PRODUCT_ID }}" data-type="@{{ catFlag }}">
                                         <img src="@{{ row.primaryImage }}" alt="Product 01"
                                     ...
                                     <div
                                         ...
                                         <div class="content-change-vertical d-flex flex-column ml-auto">
                                             ...
                                             <a href="javascript:;" data-toggle="tooltip" data-placement="left"
                                                 ...
                                                 <i
                                                     class="icon fas fa-star wish_@{{ row.PRODUCT_ID }} @{{ row.wishlistFlag == '1' ? 'activeWish' : '' }}"></i>
                                             </a>
                                             <a href="javascript:;" data-toggle="tooltip" data-placement="left"
                                                 title="Quick view"
                                     ...
                                     <div class="position-absolute pos-fixed-bottom pb-4 px-4 w-100">
                                         ...
                                         <a href="javascript:;"
                                             ...
                                             ng-if="row.INV_QUANTITY_FLAG == 'inv' && row.INV_QUANTITY > '0'">+ Quick
                                             Add</a>
                                         <a href="javascript:;"
                                             class="btn btn-white btn-block bg-hover-primary border-hover-primary hover-white"
                                             id="qckad"
                                 ...
                                 <div class="card-body pt-4 px-0 pb-0 productdetail" data-id="@{{ row.PRODUCT_ID }}"
                                     data-type="@{{ catFlag }}">
                                     <a href="javascript:;"
                                     ...
                                     <p class="text-primary mb-0 shop-subtitle card-title lh-14375 product-subtitle">
                                         @{{ row.SUB_TITLE_TXT }}</p>

                                     <div class="row">
                                         <div class="col-sm-6 col-7">
                                             <p class="text-primary mb-0 card-title lh-14375">
                                                 <span>$@{{ row.UNIT_PRICE }}</span> </p>
                                         </div>
