...
class RoutineSteps extends model
{
    ...
    protected $table="jb_routine_steps_tbl";
    /**
     ...
     */
     ...
     public function getsteps($id,$typename){
          ...
          $result = DB::table('jb_routine_steps_tbl as a')->select('a.*')
           ->where('a.NAME_ID' , $id)
        ...
        $arrRes[$i]['PRODUCT_NAME'] = $result->NAME;
        $arrRes[$i]['PRODUCT_ID'] = $result->PRODUCT_ID;
