...
<main id="content" style="padding-top: 111px">
    ...
    <hr>
    <section class="pt-10 pt-lg-10 pb-10" style="background-color:#E5E4E2;">
        <div class="container container-custom">
            <div class="row no-gutters align-items-center">
                        ...
                        <div class="card border-0 bg-transparent">
                            <div class="card-body px-3 py-0 d-flex flex-column align-items-center text-center">
                                ...
                                <ul class="list-inline mb-5 d-flex fs-15">
                                    <li class="mr-0" style="{{$review['STAR_RATING'] >= '1' ? 'color: #F89880;' : 'color: #000;'}}"><i class="fas fa-star"></i></li>
                                    <li class="mr-0" style="{{$review['STAR_RATING'] >= '2' ? 'color: #F89880;' : 'color: #000;'}}"><i class="fas fa-star"></i></li>
                                    <li class="mr-0" style="{{$review['STAR_RATING'] >= '3' ? 'color: #F89880;' : 'color: #000;'}}"><i class="fas fa-star"></i></li>
                                    <li class="mr-0" style="{{$review['STAR_RATING'] >= '4' ? 'color: #F89880;' : 'color: #000;'}}"><i class="fas fa-star"></i></li>
                                    <li class="mr-0" style="{{$review['STAR_RATING'] >= '5' ? 'color: #F89880;' : 'color: #000;'}}"><i class="fas fa-star"></i></li>
                                </ul>
