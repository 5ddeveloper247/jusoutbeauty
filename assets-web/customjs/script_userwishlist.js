...
//	});
	...
	$scope.getAllWishlistLov = function(){
		...
		$http({
			...
			$scope.displayCollectionWishlist = data.list;
			
		})
		.error(function(data, status, headers, config) {
		});
	}
	$scope.getAllWishlistLov();

	$scope.removeWishlist = function(wishlistId){
